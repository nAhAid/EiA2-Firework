...
(function (CustomFirework) {
    ...
    function getInput() {
        ...
        currentColor.style.backgroundColor = String(CustomFirework.currentFirework.colour.fColour);
        ...
        lifespan.style.background = CustomFirework.currentFirework.colour.fColour;
        size.style.background = CustomFirework.currentFirework.colour.fColour;
    }
